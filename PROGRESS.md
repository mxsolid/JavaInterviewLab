...
| A08 | 题库学习详情页 | TODO | ★★★★ | 中 | 25k–55k |
| A09 | 搜索 / 筛选 / 分页 | TODO | ★★★ | 中 | 15k–30k |
| A10 | 英文术语发音组件 | TODO | ★★ | 短 | 5k–15k |
| A11 | Seed 幂等导入 | TODO | ★★★ | 中 | 15k–30k |
| A12 | V0.1 联调 / 测试 / 验收 | TODO | ★★★★ | 中 | 20k–50k |

## V0.2 学习闭环版

| ID | 子任务 | 状态 | 难度 | 相对工作量 | 建议 Agent Token 预算 |
|---|---|---|---|---|---|
| B01 | 学习路线 / 每日计划模型 | TODO | ★★★ | 中 | 15k–35k |
| B02 | 答题记录 append-only | TODO | ★★★ | 中 | 15k–35k |
| B03 | 掌握度 + 进度事务更新 | TODO | ★★★★ | 中 | 20k–45k |
| B04 | 错题本 / 收藏 | TODO | ★★★ | 中 | 15k–30k |
| B05 | 笔记 + 自动保存 + 乐观锁 | TODO | ★★★★ | 中 | 20k–45k |
| B06 | 间隔复习调度 | TODO | ★★★★ | 中 | 20k–45k |
| B07 | 首页学习进度仪表盘 | TODO | ★★★★ | 中 | 20k–50k |
| B08 | V0.2 数据可靠性测试 | TODO | ★★★★ | 中 | 20k–50k |
...
- B01～B08：BLOCKED。开发计划要求先完成 V0.1 的 A03～A12；当前这些任务仍为 TODO，不能在缺少题库、前端和数据库基线时开始 V0.2。
