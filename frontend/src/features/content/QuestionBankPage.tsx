...
export function QuestionBankPage() {
  ...
  const [filter, setFilter] = useState<Filter>(() => ({ page: 1, pageSize: 10, status: 'ENABLED', topicId: Number(searchParams.get('topicId')) || undefined })); const [editing, setEditing] = useState<QuestionDetail | undefined>(); const [editorOpen, setEditorOpen] = useState(false); const navigate = useNavigate();
